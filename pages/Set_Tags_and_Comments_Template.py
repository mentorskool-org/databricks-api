...
def main():
    # we are using the font-awesome icons
    st.write(
    """
         <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"> 

         # Set Tags and Comments ! <i class="fa-solid fa-comment"></i>
         """,
    unsafe_allow_html=True,
)
    st.info("The comment will be reflected only in the current version of table!")
